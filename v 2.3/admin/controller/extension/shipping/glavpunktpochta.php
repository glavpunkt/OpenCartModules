...
class ControllerExtensionShippingGlavpunktpochta extends Controller
{
    ...
    public function index()
    {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/shipping/glavpunktpochta', 'token=' . $this->session->data['token'], true)
        );
        $data['action'] = HTTPS_SERVER .
            'index.php?route=extension/shipping/glavpunktpochta&token=' .
        ...
        $this->response->setOutput($this->load->view('extension/shipping/glavpunktpochta.tpl', $data));
    }
