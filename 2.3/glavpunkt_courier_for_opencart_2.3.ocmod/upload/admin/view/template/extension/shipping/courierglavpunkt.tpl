    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="courierglavpunkt_home_city" value="<?php echo $courierglavpunkt_home_city; ?>" />
            </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="courierglavpunkt_weight" value="<?php echo $courierglavpunkt_weight; ?>" size="10" />
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="courierglavpunkt_sort_order" value="<?php echo $courierglavpunkt_sort_order; ?>" size="1" />
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
              <textarea name="courierglavpunkt_widget_data" rows="1" cols="100"><?php
                echo $courierglavpunkt_widget_data; 
              ?></textarea>
              <p>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
             <textarea name="courierglavpunkt_tarif_edit_code" rows="5" cols="80"><?php
                echo $courierglavpunkt_tarif_edit_code; 
              ?></textarea>
              <p>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="courierglavpunkt_simple_status">
                <?php if ($courierglavpunkt_simple_status) { ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <?php if ($courierglavpunkt_status) { ?>
