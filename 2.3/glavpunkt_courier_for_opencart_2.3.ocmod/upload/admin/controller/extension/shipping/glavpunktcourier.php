...
class ControllerExtensionShippingGlavpunktcourier extends Controller {
    ...
    public function index() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/shipping/glavpunktcourier', 'token=' . $this->session->data['token'], true)
        );



        $data['action'] = HTTPS_SERVER . 'index.php?route=extension/shipping/glavpunktcourier&token=' . $this->session->data['token'];
