<?php
// Heading
$_['heading_title']       = "Главпункт - доставка в пункты самовывоза";
...
$_['entry_weight']    = 'Средний вес заказа (указывается если не установлен в товаре):';

// Error
$_['error_permission']    = 'Предупреждение: У Вас нет прав настраивать доставку Главпункт!';
