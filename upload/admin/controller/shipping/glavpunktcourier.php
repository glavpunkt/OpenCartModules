...
class ControllerShippingGlavpunktcourier extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $data['action'] = HTTPS_SERVER . 'index.php?route=shipping/glavpunktcourier&token=' . $this->session->data['token'];
        ...
        if (isset($this->request->post['glavpunktcourier_delivery_name'])) {
            $data['glavpunktcourier_delivery_name'] = $this->request->post['glavpunktcourier_delivery_name'];
        } else {
            $data['glavpunktcourier_delivery_name'] = $this->config->get('glavpunktcourier_delivery_name');
        }
        ...
        $this->response->setOutput($this->load->view('shipping/glavpunktcourier.tpl', $data));

    }

    private function validate() {
        if (!$this->user->hasPermission('modify', 'shipping/glavpunktcourier')) {
