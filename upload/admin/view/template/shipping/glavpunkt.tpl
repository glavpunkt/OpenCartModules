      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-auspost" class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="glavpunkt_delivery_name" value="<?php echo $glavpunkt_delivery_name; ?>" size="80" />
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="glavpunktpoints_simple_status">
              <?php if ($glavpunktpoints_simple_status) { ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select name="glavpunktpoints_payment_type">
              <?php if ($glavpunktpoints_payment_type) { ?>
