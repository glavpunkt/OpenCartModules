...
/**
 * Контроллер службы доставки "Пункты выдачи Главпункт" на странице оформления заказа
 *
...
class ControllerCheckoutGlavpunkt extends Controller
{
    ...
    public function setprice()
    {
        ...
        echo $this->request->post['city_to'] . ' <br>' .
            $this->request->post['info'] . ' <br>' .
            $this->request->post['phone'] . ' <br>' .
            $this->request->post['price'] . ' р.' .
